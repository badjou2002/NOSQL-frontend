            ...
            <Modal show={show} onHide={handleClose}>
                <Form noValidate validated={validated} onSubmit={handleUpload}>
                                ...
                                <div className='form mt-3'>
                                    ...
                                    <Row className="mb-3">
                                        ...
                                        <Form.Group as={Col} md="6">
                                            ...
                                            {!file ? <><br /><img src={imageart} style={{ width: 150, marginLeft: "30px", marginBottom: "10px", borderRadius: 10 }} /></> : null}
                                            <FilePond
                                                files={file}
                                                allowMultiple={false}
                                                onupdatefiles={setFile}
                                                labelIdle='<span className="filepond--label-action">modifier image</span>'
                                                server={{
                    ...
                    <Modal.Footer>
                        ...
                        <Button size='small' variant="outlined" color='error' onClick={handleClose} className='m-2'>
                            Fermer
                        </Button>
                        <Button size='small' variant="outlined" color='primary' type="submit">Enregistrer</Button>
                    </Modal.Footer>
                </Form>
            </Modal>
        </div>
